...
BOT_TOKEN = environ.get('BOT_TOKEN', '7641913398:AAFXyCxbGbYnhVtUVPt2kEEB0kdQj6ey5rw')
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002373145747').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('AUTH_CHANNEL')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = environ.get('-1002321871175')
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Prajwal:Prajwal>@cluster0.2r0cp.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "AUTO SENDER BOT")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'XP_FilesStore')

# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002497634922'))
